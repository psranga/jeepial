...
Example: I regularly and non-deterministically find that it take multiple
...
Aside: I don't think today's software can do multimedia multitasking as well as
BeOS did 25 years ago. What the [Taos guys wrote in ...
1995](http://www.uruk.org/emu/Taos.html) still rings true.  So let's revisit
history to see if any technologies that "lost" have useful lessons for today,
or can be used as is (e.g., BBC BASIC).


Aside: The column monthweek reflects the (arbitrary) human-designed way to group the
